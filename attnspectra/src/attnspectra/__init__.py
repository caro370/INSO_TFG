...
from attnspectra.viz.attention_maps import plot_attention_matrix

try:
    from attnspectra.viz.attention_maps import plot_attention_matrix_interactive
except ImportError:
    pass
...
if "HFTransformerAdapter" in globals():
    __all__.append("HFTransformerAdapter")

if "plot_attention_matrix_interactive" in globals():
    __all__.append("plot_attention_matrix_interactive")